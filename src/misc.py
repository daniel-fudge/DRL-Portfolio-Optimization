...
def wait_for_s3_object(s3_bucket, key, local_dir, local_prefix='', timeout=1200, limit=20, fetch_only=None,
    ...
    while len(objects) == 0:
        ...
        if training_job_name:
            status = sagemaker.describe_training_job(TrainingJobName=training_job_name)['TrainingJobStatus']
            if status == 'Failed':
...
def get_execution_role(role_name="sagemaker"):
    """
